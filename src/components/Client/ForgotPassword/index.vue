<template>
  <div class="forgot-password-wrapper d-flex align-items-center justify-content-center">
    <div class="forgot-password-box shadow bg-white p-4 rounded-4">
      ...
      <div>
        <div class="form-group mb-4">
          ...
          <div class="input-group">
            ...
            <input v-model="noi_dung.email" type="email" class="form-control" placeholder="Nhập email của bạn" />
          </div>
        </div>
...
export default {
  ...
  methods: {
   sendResetLink() {
      this.loading = true;
      axios.post('http://127.0.0.1:8000/api/phu-huynh/forgot-password', this.noi_dung)
        .then((res) => {

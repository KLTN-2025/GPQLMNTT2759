<template>
    <div class="row">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Lịch làm việc nhân viên</h5>
                    <div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-label fw-bold">
                                    <i class='bx bx-user me-2'></i>Chọn nhân viên
                                </label>
                                <select class="form-select" v-model="selectedEmployeeId" @change="loadSchedules">
                                    ...
                                    <div class="col border-end" v-for="(day, idx) in weekDays" :key="idx">
                                        <div class="p-2 h-100" style="min-height: 360px;">
                                            <div v-for="item in getSchedulesForDay(day.date)" :key="item.id"
                                                ...
                                                <div class="fw-bold small mb-1">{{ item.employee_name }}</div>
        ...
        <div class="modal fade" id="scheduleEmployeeDetailModal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <i class='bx bx-info-circle me-2'></i>
                            Chi tiết lịch làm việc nhân viên
                        </h5>
                    ...
                    <div class="modal-body">
                        <div class="schedule-detail-info">
                            <div class="info-row mb-2">
                                ...
                                <span class="ms-2">{{ selectedSchedule.employee_name }}</span>
                            </div>
                            <div class="info-row mb-2">
                                <span class="fw-bold">
...
export default {
    ...
    methods: {
        ...
        viewScheduleDetail(schedule) {
            ...
            const modal = new bootstrap.Modal(document.getElementById('scheduleEmployeeDetailModal'));
            modal.show();
        },
            ...
            baseRequestAdmin
                ...
                .then((res) => {
                    if (res.data.status) {
                        ...
                        this.$toast.error(res.data.message || 'Có lỗi xảy ra khi tải danh sách nhân viên');
                    }
                })
                .catch((err) => {
        ...
        loadSchedules() {
            ...
            if (this.selectedEmployeeId) {
                searchData.id_nhan_vien = this.selectedEmployeeId;
            }
            ...
            baseRequestAdmin
                .post('admin/lich-lam-viec/nhan-vien/search', searchData)
                .then((res) => {
                    if (res.data.status) {
                        ...
                        this.schedules = (res.data.data || []).map(item => ({
                            ...
                            employee_name: item.ho_va_ten || 'Không xác định',
            ...
            baseRequestAdmin
                ...
                .then((res) => {
                    if (res.data.status) {
                        ...
                        this.loadSchedules();
                        // Đóng modal
                        const modal = bootstrap.Modal.getInstance(document.getElementById('scheduleEmployeeDetailModal'));
                        if (modal) modal.hide();
                    } else {
